package com.rf.hp.normaluniversitystu.view;
...
public class ViewIndicator extends LinearLayout implements View.OnClickListener {
    ...
    private static final int COLOR_SELECT = Color.argb(255, 34, 105, 213);
    ...
    private static final int IMG_ID_BIG = 1;
    private static final int IMG_ID_SMALL = 2;
     ...
     * @return
     */
    public View createIndicator(int iconResID, int stringResID, int stringColorID, String iconTag, String textTag,boolean isNewMsg) {
        //实例化一个LineaLayout
        LinearLayout view = new LinearLayout(getContext());
        RelativeLayout view2 = new RelativeLayout(getContext());
        ...
        img.setImageResource(R.mipmap.new_message);
        img.setId(IMG_ID_SMALL);
        RelativeLayout.LayoutParams lp1 = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        /*lp1.addRule(RelativeLayout.SCROLLBAR_POSITION_LEFT, IMG_ID_BIG);
        lp1.addRule(RelativeLayout.ALIGN_LEFT, IMG_ID_SMALL);*/
        lp1.addRule(RelativeLayout.BELOW, IMG_ID_SMALL);
        lp1.addRule(RelativeLayout.ALIGN_RIGHT, IMG_ID_BIG);
        //设置文字资源
        textView.setText(stringResID);
        //view2.setGravity(Gravity.CENTER);
        view2.setHorizontalGravity(Gravity.CENTER);
        if(isNewMsg){
            view2.addView(img,lp1);
        }
        view2.addView(iconView);
    ...
    private void init() {
        ...
        //第一个为默认选中显示的
        //考勤
        mIndicators[0] = createIndicator(R.mipmap.tab_home_focus, R.string.str_kaoqin_kaoqin, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0,false);
        mIndicators[0].setBackgroundResource(R.drawable.main_tab_item_bg);
        mIndicators[0].setTag(Integer.valueOf(0));
        mIndicators[0].setOnClickListener(this);
        addView(mIndicators[0]);
        //学习
        mIndicators[1] = createIndicator(R.mipmap.tab_find_normal, R.string.str_learn_learn, COLOR_UNSELECT, TAG_ICON_1, TAG_TEXT_1,false);
        mIndicators[1].setBackgroundResource(R.drawable.main_tab_item_bg);
        mIndicators[1].setTag(Integer.valueOf(1));
        mIndicators[1].setOnClickListener(this);
        addView(mIndicators[1]);
        //通知
        mIndicators[2] = createIndicator(R.mipmap.tab_shop_normal, R.string.str_noice_noice, COLOR_UNSELECT, TAG_ICON_2, TAG_TEXT_2,isNewMess());
        ...
        //我的
        mIndicators[3] = createIndicator(R.mipmap.tab_mine_normal, R.string.str_mine_mine, COLOR_UNSELECT, TAG_ICON_3, TAG_TEXT_3,false);
